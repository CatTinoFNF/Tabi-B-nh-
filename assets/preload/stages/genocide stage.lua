function onCreate()
   ...
   addAnimationByPrefix('sexualintercourse','first','khabanhmuaquat',30,true);
   ...
   addAnimationByPrefix('sexualintercourse1','first','khabanhmuaquat',30,true);
   ...
   addAnimationByPrefix('sexualintercourse2','first','khabanhmuaquat',30,true);
   ...
   addAnimationByPrefix('sexualintercourse3','first','khabanhmuaquat',30,true);
   ...
   addAnimationByPrefix('sexualintercourse4','first','khabanhmuaquat',30,true);
   ...
   makeAnimatedLuaSprite('sexualintercourse5', 'khabanhphanthan', 850,400);
   addAnimationByPrefix('sexualintercourse5', 'first', 'khabanhmuaquat', 24, true);
